      ...
      <div className="w-full space-y-1.5">
        ...
        <div className="relative">
          <input
            ref={ref}
            className={cn(
              "w-full bg-[#0a0c14] border-2 border-[#2b324a] px-3.5 py-2.5 text-sm text-zinc-100 placeholder:text-zinc-500 font-mono shadow-[2px_2px_0px_0px_#000000] focus:border-emerald-500 focus:shadow-[3px_3px_0px_0px_#064e3b] focus:outline-none transition-all disabled:opacity-50",
